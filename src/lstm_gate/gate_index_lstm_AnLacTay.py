...
if STATION_NAME not in STATION_GATE_CONFIG:
    raise KeyError(
        f"No gate driver mapping for station {STATION_NAME!r}. "
        "Update STATION_GATE_CONFIG to match your station."
    )

LOCAL_H_COL = STATION_GATE_CONFIG[STATION_NAME]["local_h"]
TIDE_H_COL = STATION_GATE_CONFIG[STATION_NAME]["tide_h"]
RAIN_COL = STATION_GATE_CONFIG[STATION_NAME]["rain"]
